...
reset:
   ...
   ;ldi r16,lo8(RAMEND) ;set automatically
   ;out SPL,r16 ;set automatically
   ;ldi r16,hi8(RAMEND) ;set automatically
   ;out SPH,r16 ;set automatically
...
wait:
   ...
   eor r17,r17 ; ~12 million cycles
   eor r18,r18 ; ~0.7s at 16Mhz
_w0:
   dec r18
   brne _w0
   dec r17
